  ...
  return (
    <View style={{ flex: 1, backgroundColor: AUDIT.bg, paddingTop: insets.top }}>
      <View style={{ padding: SPACING.lg, paddingBottom: SPACING.md }}>
        ...
        <Text style={{ fontSize: 13, color: AUDIT.textMuted, marginTop: 4 }}>
          {data?.length ?? 0} field inspection reports
        </Text>
      </View>
        ...
        <SectionList
          ...
          renderSectionHeader={({ section: { title, subtitle } }) => (
            <View style={{ marginBottom: SPACING.md, marginTop: SPACING.sm }}>
              <Text style={{ fontSize: 13, fontWeight: '800', color: AUDIT.accent, letterSpacing: 1 }}>
                {title.toUpperCase()}
              </Text>
              {subtitle ? (
            ...
            if (item.kind === 'folder') {
              return (
                ...
                >
                  ...
                  >
                    <Ionicons name="folder" size={24} color="#a5b4fc" />
                  </View>
                  <View style={{ flex: 1 }}>
