/** Types and grouping helpers for audit report browsing (web management report). */
...
export function reportsInMonth(reports: AuditReportRow[], yearMonth: string): AuditReportRow[] {
  return reports
